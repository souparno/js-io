    ...
    */
    ...
    function makeContext(ctx, modulePath, moduleDef, dontAddBase) {
        ...
        if (!dontAddBase && modulePath != 'jsio.base') {
            ctx.jsio('from jsio.base import *', {
                dontPreprocess: true
            });
...
jsio.setCache({
    ...
    "example2/app.js": {
        "path": "example2/app.js",
        "friendlyPath": ".example2.app",
        "directory": "example2/",
        "filename": "app.js",
        "src": "jsio('import .calculator as calculator');\n\ncalculator.add(2, 3);\n",
        "pre": true
    },
    "example2/calculator.js": {
        "path": "example2/calculator.js",
        "friendlyPath": ".calculator",
        "directory": "example2/",
