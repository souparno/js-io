...
exports.generateSrc = function(opts, callback) {
  ...
  opts['compressSources'] = false;
  opts['includeJsio'] = true;
  ...
  var cb = (function(ctx) {
    ...
    return function() {
      ...
      return buildJsio.apply(ctx, args);
    };
  }(this, opts, callback));
...
exports.getPathJS = function() {
  ...
  return 'jsio.path.set(' + JSON.stringify(jsio.path.get().map(function(value) {
...
function checkDynamicImports(moduleDef) {
  ...
  if (!gDynamicList[directory]) {
    ...
    var module = JSIO.__require(null, directory, 'compiler', './__imports__', {
      dontExport: true,
      suppressErrors: true
    });
